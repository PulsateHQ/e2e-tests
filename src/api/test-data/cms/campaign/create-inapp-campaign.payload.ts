...
export const createCampaignInAppLargeWithOpenFeed = (
  ...
  type: 'InAppNotificationCampaign',
  last_builder_page: '1',
  name: `InApp_Large_Campaign_Button_OpenFeed_${faker.lorem.word()}`,
  control_group: null,
  goals: [
    {
      primary: true,
  ...
  in_app_notification: {
    large: {
      ...
      headline: {
        side: 'front',
        active: true,
        text: `Headline_InApp_Large_Campaign_Button_OpenFeed_${faker.lorem.word()}`,
        position: 1
      },
      text: {
        side: 'front',
        active: true,
        text: `Text_InApp_Large_OpenFeed_${faker.lorem.word()}`,
        position: 2
      },
      call_to_action: {
        buttons: [
