...
/**
 * Retrieves a list of reports for an app with optional filtering and pagination.
 ...
 */
export async function getReportsWithApi(
  ...
  const url = `${urls.apps.v2.base}/${appId}/reports?sort=${sort}&order=${order}&page=${page}&per_page=${perPage}`;
