...
/**
 * Retrieves a list of events for an app with optional filtering and pagination.
 ...
 */
export async function getEventsWithApi(
  ...
  const url = `${urls.apps.v2.base}/${appId}/events?sort=${sort}&order=${order}&page=${page}&per_page=${perPage}`;
